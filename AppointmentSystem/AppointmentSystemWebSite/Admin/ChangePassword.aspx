<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/CompanyAdmin.master" AutoEventWireup="true" CodeFile="ChangePassword.aspx.cs" Inherits="Admin_ChangePassword" %>
                ...
                <div class="panel-body panel-form">
                    <div class="form-group">
                        ...
                        <div class="col-md-5 col-sm-5">
                            <asp:TextBox runat="server" ID="txtOldPassword" CssClass="form-control" name="txtOldPassword" placeholder="Old Password" MaxLength="20" TabIndex="1"  TextMode="Password" />
