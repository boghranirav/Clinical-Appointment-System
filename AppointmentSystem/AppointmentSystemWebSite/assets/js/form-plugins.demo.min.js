...
var handleFormTimePickerMorFrom = function () {
    "use strict";
    $("#timepickermorfrom").timepicker({
        defaultTime: 'value',
        minuteStep: 5,
        disableFocus: true,
        template: 'dropdown'
...
var handleFormTimePickerMorTo = function () {
    "use strict";
    $("#timepickermorto").timepicker({
        defaultTime: 'value',
        minuteStep: 5,
        disableFocus: true,
        template: 'dropdown'
...
var handleFormTimePickerEveFrom = function () {
    "use strict";
    $("#timepickerevefrom").timepicker({
        defaultTime: 'value',
        minuteStep: 5,
        disableFocus: true,
        template: 'dropdown'
...
var handleFormTimePickerEveTo = function () {
    "use strict";
    $("#timepickereveto").timepicker({
        defaultTime: 'value',
        minuteStep: 5,
        disableFocus: true,
        template: 'dropdown'
...
var FormPlugins = function () {
    ...
    return {
        init: function () {
            ...
            handleFormTimePickerMorFrom();
            handleFormTimePickerMorTo();
            handleFormTimePickerEveFrom();
            handleFormTimePickerEveTo();
